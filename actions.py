...
class ActionGetActiveAssignmetns(Action):
    ...
    def run(self,
        ...
        url = 'http://localhost:8089/getProviderInfo?providerNumber={providerNumber}'.format(providerNumber=providerNumber)
...
class SubmitTimeEntryInfo(FormAction):
    ...
    def submit(
        ...
        dispatcher.utter_message(response="utter_time_entry_summary")
        return []
